...
export const VotingAppExample: Story = {
  args: {},
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '350px' }}>
      <label style={{ fontSize: '14px', fontWeight: '700', fontFamily: "'VT323', monospace" }}>
        INGRESA TU NOMBRE
      </label>
      <Input size="md" placeholder="Tu nombre..." />
      <p style={{ fontSize: '12px', color: '#666', margin: '0' }}>
        Please enter your name to vote for your prediction.
      </p>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Example: Input as used in the Gender Reveal Voting App for collecting participant names.',
      },
    },
  },
};
